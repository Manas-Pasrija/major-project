...
<body>
	...
	<!-- navigation bar end -->
	    ...
	    <div class="container">
				...
				<h3 id="heading3">What's Your Question Today? Let's Discuss!</h3>
	
	   
		       <form class="form-horizontal" action="/action_page.php" id="topic-q-form"  class="col-md-offset-3">
				         <div class="form-group ">
						    <div class="col-sm-6 ">
						    ...
						    <div class="col-sm-6 "> 
						      <textarea rows="5" class="form-control" id="tpc" placeholder="Write description....."></textarea> 
								     ...
								     <div class="form-group">
										...
										<button type="submit" class="btn p-btn">Post To Timeline</button>
